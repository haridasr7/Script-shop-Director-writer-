          ...
          <Grid item xs={12} lg={6}>
            <Container sx={{ overflowX: "hidden" }}>
              ...
              <div className="onepara">
                <p>
                  Script Shop is a gathering of writers and directors. The
                  cleverest way to share scripts and synopsis, easy
                  collaborations.
                </p>
              </div>
              <div>
                {isAuthenticated ? (
                  <Link to="/PublishScript">
                    <Button
                      className="lbcustom-button"
                      variant="contained"
                      style={{ backgroundColor: "#14ABE4" }}
                    >
          ...
          <GridContainer>
            <Grid container spacing={2}>
              <Grid item xs={12} md={4} sm={12} lg={4}>
                ...
                >
                  It allows writers and directors can easily collaborate on film
                  projects, streamlining the scriptwriting process. Directors
                  can scout for fresh talent and unique scripts that might not
                  have been accessible through traditional channels.
                </Card>
              </Grid>
              <Grid item xs={12} md={4} sm={12} lg={4}>
                <Card
                ...
                >
                  ...
                  engagement, helping writers understand how readers respond to
                  their work. Writers can showcase their scripts to a broader
                  audience, increasing their chances of getting noticed and
                  potentially having their scripts produced
                </Card>
              </Grid>
              <Grid item xs={12} md={4} sm={12} lg={4}>
                <Card
                ...
                >
                  ...
                  work. Users can receive feedback and reviews on their scripts,
                  helping them refine and improve their work.
                </Card>
              </Grid>
            </Grid>
          </GridContainer>
