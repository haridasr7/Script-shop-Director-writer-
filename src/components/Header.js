...
const Header = () => {
    ...
    const dropdownContent = (
        <div style={{ backgroundColor: "white", padding: '5px', borderRadius: '4px', position: 'absolute' }}>
        ...
        <div className='writerhomem' >
          ...
          <div className='DHMS1D2'>
            <div className='DHMS1D2S'>
              <Typography id='DHMS1D2ST1'>Who doesn't like watching movies?</Typography>
              <Typography id='DHMS1D2ST2'><i>Let's watch your movie togethe</i></Typography>
              <Typography id='DHMS1D2ST4'><i>Publish.Connect.Cooperate</i></Typography>
            </div>
          </div>
        </div>
            <Container >
                ...
                <div className='maincontainer' style={{ display: 'flex', marginTop: '5%' }}>
                    <Grid container spacing={2} >
                        ...
                        <Grid item xs={12} md={6} lg={4} sm={6}>
                            <div style={{ cursor: 'pointer' }} onClick={() => navigate('/myscript')}>
                                <Card sx={{ width: 298, height: 410, borderRadius: 5, border: '1px solid #14ABE4' }}>
                                    <CardMedia
                                        component="img"
                                        sx={{ height: 140 }}
