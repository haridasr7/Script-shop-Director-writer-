...
// // import { clearSuccessMessage, clearloadingError, getWriterProfile } from "../../../actions/writerAction";
// import { toast } from "react-toastify";
// import NavbarWriter from "./writernavbar/NavbarWriter";
// import { addWriterProfile, getWriterProfile } from "../actions/writerAction";
// function Profile() {
...
//     isAuthenticated,
//     message,
//   } = useSelector((state) => state.writerState);
//   const { user } = useSelector((state) => state.authState);
//   useEffect(() => {
//     if (user.profile) {
//       dispatch(getWriterProfile(user._id));
//     }
//   }, [dispatch, user]);
//   useEffect(() => {
