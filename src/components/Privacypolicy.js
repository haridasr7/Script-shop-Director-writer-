    ...
    return (
        <div>
            ...
            <div className='wprivacypolicy' style={{ marginTop: '15%' }}>
                <Container >
                    <Box>
                        <h3>Privacy & Policy for <span style={{ color: 'blue' }}>ScriptShop</span></h3>
                        <h4 style={{ marginTop: '4%' }}>ScriptShop is committed to protecting the privacy of our users. This Privacy Policy outlines
                            how we collect, use, disclose, and protect your personal information when you use our
                            ScriptShop website and application (collectively referred to as the "Service").
                            By using our Service, you agree to the practices described in this Privacy Policy. If you do
                            not agree to this Privacy Policy, please do not use our Service.</h4>
                    </Box>
                    <Box
                        sx={{
                            padding: '20px',
                    ...
                    >
                        <p><h3>1. Information We Collect</h3><br /><br />
                            <b>Information You Provide:</b><br /><br /> When you sign up for an account, use our Service, or
                            communicate with us, we may collect personal information, including but not limited to:<br /><br />
                            - Your name<br />
                            - Email address<br />
                            - Username and password<br />
                            - Profile information (e.g., biography, profile picture)<br />
                            - Scripts and content you upload<br />
                            - Communications with other users <br /><br />
                            <b>Automatically Collected Information:</b> <br /><br />  We may automatically collect certain information
                            when you use our Service, such as:<br />
                            - Device information (e.g., device type, operating system)<br />
                            - Usage information (e.g., log data, analytics)<br />
                            - Cookies and similar tracking technologies<br /><br />
                            ...
                            However, if You do not accept Cookies, You may be unable to use some parts of our
                            Service. Unless you have adjusted Your browser setting so that it will refuse cookies, our
                            Service may use Cookies.<br /><br />
                            ...
                            pixel gifs) that permit the Company, for example, to count users who have visited those
                            pages or opened an email and for other related website statistics (for example, recording the
                            popularity of a specific section and verifying system and server integrity).
                            Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your
                            personal computer or mobile device when You go offline, while Session Cookies are deleted
                            as soon as You close Your web browser. We use both Session and Persistent Cookies for
                            the purposes set out below:<br /><br />
                           ...
                           <b>Cookies Policy / Notice Acceptance Cookies</b> <br /><br />
                            ...
                            these Cookies is to provide You with a more personal experience and to avoid having to re-
                            enter your preferences every time You use the Website.<br /><br />
                            For more information about the cookies we use and your choices regarding cookies, please
                            visit our Cookies Policy or the Cookies section of our Privacy Policy.<br /><br />
                            2.<h1> How We Use Your Information</h1> <br /><br />
                            The Company may use Personal Data for the following purposes:<br /><br />
                            To provide and maintain our Service, including monitoring the usage of our Service.<br /><br />
                            ...
                            that are available to You as a registered user.<br /><br />
                            ...
                            services and events that we offer that are similar to those that you have already purchased
                            or enquired about unless You have opted not to receive such information.<br /><br />
                            ...
                            campaigns and evaluating and improving our Service, products, services, marketing and
                            ...
                            Providers to monitor and analyze the use of our Service, and to contact You.<br /><br />
                            ...
                            name, profile, pictures and description of Your activity. Similarly, other users will be able to
                            view descriptions of Your activity, communicate with You and view Your profile.<br /><br />
                            3. <b>Information from Third-Party Social Media Services</b><br /><br />
                            ...
                            to use, share, and store it in a manner consistent with this Privacy Policy.<br /><br />
                            4.<b>Your Choices</b> <br /><br />
                            You can control certain information by:
                            - Updating your account settings
                            - Adjusting your privacy preferences
                            - Deleting your account (subject to our retention policies)<br /><br />
                            5.<b> Security</b><br /><br />
                            The security of Your Personal Data is important to Us, but remember that no method of
                            transmission over the Internet, or method of electronic storage is 100% secure. While We
                            strive to use commercially acceptable means to protect Your Personal Data, We cannot
                            guarantee its absolute security.<br /><br />
                            6.<b>Changes to this Privacy Policy</b> <br /><br />
                            We may update this Privacy Policy from time to time, and any changes will be posted on this
                            page with an updated effective date. Your continued use of the Service after any changes
                            constitute your acceptance of the revised Privacy Policy.<br /><br />
                            7.<b> Contact Us</b> <br /><br />
