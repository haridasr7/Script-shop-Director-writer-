  ...
  return (
    ...
    <nav className="CommonNavbar">
      <div className="Navleft-section">
        <Link style={{ textDecoration: 'none' }} id='DNImageLink' to={'/Directorhome'}><img className='CNavLogo' src="/images/navbarLogo.png" alt="Logo"  style={{ display: 'block' }}/></Link>
      </div>
      <div className="Navcenter-section">
        <Link  to="/Directorhome" className={location.pathname === '/Directorhome' ? 'Navbaractive' : 'NavbarInactive'}>
         <Typography id='navbarC3Typo' > Home</Typography>
        </Link>
        <Link to="/services" className={location.pathname === '/services' ? 'Navbaractive' : 'NavbarInactive'}>
        <Typography id='navbarC3Typo1'> Services </Typography>
        </Link>
        <Link to="/ContactUs" className={location.pathname === '/ContactUs' ? 'Navbaractive' : 'NavbarInactive'}>
      ...
      <div className="Navright-section">
        ...
        <IconButton className="arrow-button" onClick={(event) => {event.stopPropagation();handleArrowClick();}} disableRipple>
        ...
        {isOpenD1 && (
          <div className="navbarCdropdown-menuD1 " ref={dropdownRef}>
            ...
            <ul className='navbarCdropdown-menuUL'>
              <Link to='/directorprofile' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Profile</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/myfavorites' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Favorites</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
    ...
    <div className='navbarFollowers'>
      ...
      <IconButton id='NavbarCMenu' sx={{marginLeft: "auto"}} onClick={(event)=>{ event.stopPropagation(); setIsOpenD1(!isOpenD1)}}>
            <MenuIcon/>
      </IconButton>
      {isOpenD1 && (
          <div className="navbarCdropdown-menuD2" >
            <div className='navbarCdropdown-menuDiv'><Typography className='navbarCdropdown-menuTypo'>Menu</Typography><IconButton onClick={()=> setIsOpenD1(!isOpenD1)}> <CloseIcon/></IconButton></div>
            <hr className='navdropHr2'></hr>
            <ul className='navbarCdropdown-menuUL'>
            
              <Link to='/Directorhome' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Home</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/services' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Services</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/ContactUs' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Contact Us</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/directorprofile' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Profile</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/myfavorites' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Favorites</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/updatepassword' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Update Password</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/customersupport' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Customer Support</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link to='/privacy&policy' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Privacy & Policy</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <Link  to='/purchasehistory' className='navbarCdropdown-menuULLink'><li><div className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Purchase History</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li></Link>
              <li><div onClick={directorHomeLogout} className='navbarCdropdown-menuLi'><p className='navbarCdropdown-menuTypo'>Logout</p><IconButton> <KeyboardArrowRightIcon/></IconButton></div></li>
